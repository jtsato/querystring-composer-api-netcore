...
public sealed class ServiceResolver : IServiceResolver
{
    ...
    {
        return _clientRepository ??= new ClientRepository(_connectionFactory, _databaseName, _queryStructureCollectionName);
    }

    private ISequenceRepository<ClientSequence> GetClientSequenceRepository()
    {
        return _clientSequenceRepository ??=
            new ClientSequenceRepository(_connectionFactory, _databaseName, _queryStructureSequenceCollectionName);
    }
